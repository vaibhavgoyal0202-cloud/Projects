      ...
      <header className="top-nav">
        <div className="container nav-wrapper">
          <div className="brand-logo" onClick={() => { setActivePortal('public'); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
            <div className="logo-badge">DS</div>
            <div className="logo-text">
              <div className="logo-title">
                DS-<span>NEXUS</span>
              </div>
              <div className="logo-subtitle">ABES EC · Data Science Dept</div>
            </div>
          </div>
      ...
      {activePortal === 'student' && user?.role === 'student' ? (
        ...
        <main className="container">
            ...
            <div className="hero-banner">
              <div className="hero-content">
                ...
                <h1 className="hero-title">
                  Archival Gateway for <em>Seminars, Workshops & Industry Visits</em>
                </h1>
                <p className="hero-desc">
                  Explore academic sessions, comprehensive presentation slides (PPTs), high-resolution photographic albums, curriculum-mapped competencies, and verified digital certificates.
                </p>

                <div className="telemetry-grid">
                  <div className="stat-item">
                    <div className="stat-val">2026-27<span>*</span></div>
                    <div className="stat-lbl">Active Session</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-val">{events.length}<span>+</span></div>
                    <div className="stat-lbl">Archived Sessions</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-val">
                      {events.reduce((sum, e) => sum + (e.photos?.length || 0), 0)}<span>+</span>
                    </div>
                    <div className="stat-lbl">Event Photographs</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-val">100<span>%</span></div>
                    <div className="stat-lbl">Verified Certificates</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="controls-bar">
            <div className="session-tabs-row">
              <div className="session-pills">
                ...
                <button
                  className={`session-tab ${selectedSession === '2026-27' ? 'active current' : ''}`}
                  onClick={() => setSelectedSession('2026-27')}
                >
                  🟢 2026-27 (Current)
                </button>
                <button
                  className={`session-tab ${selectedSession === '2025-26' ? 'active' : ''}`}
                  onClick={() => setSelectedSession('2025-26')}
                >
                  📁 2025-26 (Past)
                </button>
                <button
                  className={`session-tab ${selectedSession === '2024-25' ? 'active' : ''}`}
                  onClick={() => setSelectedSession('2024-25')}
                >
                  📁 2024-25 (Past)
                </button>
                <button
            ...
            <div className="categories-row">
              {[
                ...
                { id: 'workshop', label: '🛠️ Hands-on Workshops' },
                { id: 'seminar', label: '💡 Expert Seminars' },
                { id: 'industry_visit', label: '🏭 Industry Visits' },
                { id: 'guest_lecture', label: '🎙️ Guest Lectures' },
          ...
          <section className="events-grid">
            {events.length === 0 ? (
              <div style={{ gridColumn: '1 / -1', textAlign: 'center', padding: '60px 20px', background: 'var(--bg-card)', borderRadius: 'var(--radius-lg)' }}>
        ...
        <div>
          ...
          {filteredAttended.length === 0 ? (
            ...
            filteredAttended.map(reg => (
              <div key={reg.id} className="ticket-card" style={{ borderColor: reg.certificateIssued ? '#ffd700' : 'var(--line)' }}>
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', gap: '8px', marginBottom: '6px' }}>
                    ...
                    {reg.certificateIssued && (
                      <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.68rem', color: '#ffd700', padding: '2px 8px', border: '1px solid #ffd700', borderRadius: '99px' }}>
                  ...
                  {reg.certificateId && (
                    <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.74rem', color: '#ffd700' }}>
        ...
        <div style={{ padding: '20px 36px 36px' }}>
          <div className="certificate-preview-card" id="printable-certificate">
            ...
            <div className="cert-header-seal">
              <div>
                <h2 className="cert-inst-title">ABES ENGINEERING COLLEGE</h2>
                <div className="cert-dept-tag">DEPARTMENT OF DATA SCIENCE & ARTIFICIAL INTELLIGENCE</div>
              </div>
              <div style={{ textAlign: 'right', fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: '#ffd700' }}>
            ...
            <div style={{ textAlign: 'center', margin: '28px 0' }}>
              ...
              <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.84rem', color: 'var(--cyan)' }}>
            ...
            <div className="cert-footer-row">
              <div>
                ...
                <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>Faculty Event Convener, DS Dept</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ fontSize: '0.68rem', color: 'var(--text-dim)', marginTop: '2px' }}>
                  Digitally Authenticated by ABES DS Examination & Academic Cell
                </div>
              </div>
              <div style={{ textAlign: 'right' }}>
                <div style={{ fontWeight: 700, fontSize: '0.86rem' }}>Prof. (Dr.) Sanjay Singh</div>
                <div style={{ fontSize: '0.72rem', color: 'var(--text-muted)' }}>Head of Department (DS & AI)</div>
              </div>
            </div>
          </div>

          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px' }}>
            <button className="btn-primary" onClick={handlePrint} style={{ background: 'linear-gradient(135deg, #ffd700, #ffaa00)', color: '#000' }}>
